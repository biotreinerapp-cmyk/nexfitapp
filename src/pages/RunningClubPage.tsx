    ...
    <main className="safe-bottom-main flex min-h-screen flex-col gap-4 bg-background px-4 pt-4">
      <header className="mb-2 flex items-center gap-3">
        ...
        <div className="flex flex-col">
          ...
          <h1 className="mt-1 page-title-gradient text-xl font-semibold tracking-tight">Corra junto. Evolua junto.</h1>
        </div>
      </header>

      <section className="space-y-3">
        <Button className="w-full" size="lg" onClick={() => setCreateDialogOpen(true)}>
          <Plus className="h-4 w-4" /> Criar meu clube de corrida
        </Button>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex flex-col items-end text-xs">
                        ...
                        <span className="text-[10px] text-muted-foreground">acumulado pelo clube</span>
                      </div>
                    </button>
                  </Card>
                );
